...
class _RightPanelState extends State<RightPanel> {
  ...
  Widget build(BuildContext context) {
    ...
    if (stickers.selectedPack == null || stickers.selectedPackWidgets == null) {
      return Container();
    }
    ...
    var searchColor = noResult
        ? Color.alphaBlend(theme.sbErrorOverlay, theme.sbBackgroundColor)
        : theme.sbBackgroundColor;

    return Stack(
      children: [
        stickers.selectedPackWidgets!.isEmpty
            ? Column(
                ...
                child: ScrollConfiguration(
                  ...
                  child: CustomScrollView(
                    ...
                    slivers: [
                      ...
                      stickers.selectedPackWidgets == null
                          ...
                          SliverPadding(
                              ...
                              sliver: SliverGrid(
                                ...
                                delegate: SliverChildBuilderDelegate(
                                    ...
                                    childCount: (stickers.filteredWidgets ?? [])
                                            .isEmpty
                                        ? stickers.selectedPackWidgets!.length
                                        : stickers.filteredWidgets!.length),
                              ),
                            ),
                      ValueListenableBuilder(
                          valueListenable: settings.showSearchBar,
                          builder: (context, show, _) {
                            return stickers.selectedPackWidgets!.isEmpty ||
                                    !show
                                ? const SliverPadding(
                          ...
                          child: ClipRRect(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(12),
                                  border:
                                      Border.all(color: theme.sbBorderColor),
                                  color: searchColor),
